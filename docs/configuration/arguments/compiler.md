...
[opt_name](arguments_reference.md#opt_name)  argument. For this example, we'll be using the example found in the 
...
::: tip
If the [`output_tag`](arguments_reference.md#output_tag) argument is set to to false, Redux will not auto-echo a tag into the page header.
:::
